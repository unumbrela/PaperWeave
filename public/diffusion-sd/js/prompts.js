// NOTE: trimmed to 3 prompt pairs whose precomputed assets are vendored locally.
// Original ships 13 pairs; see https://github.com/poloclub/diffusion-explainer (MIT).
window.prompts = [
