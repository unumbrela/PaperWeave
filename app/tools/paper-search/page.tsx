...
import { ArchitectureIntro } from "@/components/paper-search/ArchitectureIntro";
      ...
      <div className="space-y-5">
        ...
        <div ref={resultsRef} className="grid gap-5 scroll-mt-24 lg:grid-cols-[minmax(0,1fr)_228px]">
          <section className="surface flex min-h-[480px] flex-col overflow-hidden rounded-[20px]">
            ...
            {/* 初始空态：讲清检索架构 / 流程 / 优势，再引导开始 */}
            {!isLoading && !hasSearched && results.length === 0 && (
              <div className="flex flex-1 flex-col items-center gap-8 overflow-y-auto p-6 sm:p-8">
                <ArchitectureIntro />
